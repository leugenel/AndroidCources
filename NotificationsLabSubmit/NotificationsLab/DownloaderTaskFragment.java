...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		resourceIDS[0] = MainActivity.sRawTextFeedIds.get(0);
		resourceIDS[1] = MainActivity.sRawTextFeedIds.get(1);
		resourceIDS[2] = MainActivity.sRawTextFeedIds.get(2);
	...
	// TO DO: Implement an AsyncTask subclass called DownLoaderTask.
			...
			mContext.sendOrderedBroadcast(new Intent(
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							// TO DO: Check whether or not the MainActivity
							// received the broadcast
							if(getResultCode() != MainActivity.IS_ALIVE){
								System.out.println("Not a MainActivity");
								// TO DO: If not, create a PendingIntent using
								// the
								...
								System.out.println("In a MainActivity");
